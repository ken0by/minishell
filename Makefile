...
#    Updated: 2024/01/10 15:15:12 by rofuente         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
BUILT	=	ft_cd.c ft_echo.c ft_ecutil.c ft_export.c ft_exutil.c ft_exutil.2c ft_print.c ft_unset.c
PARSE	=	ft_parse.c ft_parse2.c ft_parse3.c ft_parse4.c ft_parse5.c ft_parse_error.c
PIPE	=	ft_pipe.c ft_pipe_utils.c ft_pipe_utils2.c ft_pipe_utils3.c ft_pipe_join.c
